...
import { CurrenciesEnum, Currencies, CurrenciesSymbol, currenciesList, getConvertedAmount } from 'shared/constants/currencies';
        ...
        <Form.Field.Radio 
            ...
            renderValue={({ amount, label: description }, active) => (
                <Donation active={active}>
                    ...
                    <Amount>{getConvertedAmount(amount, currency)}</Amount>
